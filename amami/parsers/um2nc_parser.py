...
class Um2ncParser():
    """Class to define parser for the `um2nc` subcommand"""
...
Default: 0.5."""
    ...
    _mutual = PARSER.add_mutually_exclusive_group()
...
Cannot be used together with '--include'."""
    ...
    @staticmethod
    def preprocess(known_args: argparse.Namespace, unknown_args: List[str]) -> argparse.Namespace:
        """
